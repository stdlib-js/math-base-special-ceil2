...
var ceil2 = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( ceil2 instanceof Error )
};
...
tape( 'the function overflows if provided a sufficiently large positive value', opts, function test( t ) {
	var x;
	var v;
